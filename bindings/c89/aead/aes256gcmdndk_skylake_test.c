...
#include "aes256gcmdndk_skylake.h"

int main(void) {
  haberdashery_aes256gcmdndk_skylake_t aead;
  unsigned char key[HABERDASHERY_AES_256_GCMDNDK_SKYLAKE_KEY_LEN] = {0};
  unsigned char nonce[HABERDASHERY_AES_256_GCMDNDK_SKYLAKE_NONCE_LEN] = {0};
  unsigned char tag[HABERDASHERY_AES_256_GCMDNDK_SKYLAKE_TAG_LEN] = {0};
