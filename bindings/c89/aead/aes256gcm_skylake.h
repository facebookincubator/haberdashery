...
#define HABERDASHERY_AES_256_GCM_SKYLAKE_KEY_LEN 32
#define HABERDASHERY_AES_256_GCM_SKYLAKE_NONCE_LEN 12
#define HABERDASHERY_AES_256_GCM_SKYLAKE_TAG_LEN 16

__attribute__((aligned(16)))
typedef struct haberdashery_aes256gcm_skylake_t {
  uint8_t value[336];
...
int haberdashery_aes256gcm_skylake_encrypt(
    haberdashery_aes256gcm_skylake_t *const aead,
