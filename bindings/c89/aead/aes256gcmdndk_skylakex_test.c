...
#include "aes256gcmdndk_skylakex.h"

int main(void) {
  haberdashery_aes256gcmdndk_skylakex_t aead;
  unsigned char key[HABERDASHERY_AES_256_GCMDNDK_SKYLAKEX_KEY_LEN] = {0};
  unsigned char nonce[HABERDASHERY_AES_256_GCMDNDK_SKYLAKEX_NONCE_LEN] = {0};
  unsigned char tag[HABERDASHERY_AES_256_GCMDNDK_SKYLAKEX_TAG_LEN] = {0};
