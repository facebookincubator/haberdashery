...
#include "aes256gcmsiv_haswell.h"

int main(void) {
  haberdashery_aes256gcmsiv_haswell_t aead;
  unsigned char key[HABERDASHERY_AES_256_GCMSIV_HASWELL_KEY_LEN] = {0};
  unsigned char nonce[HABERDASHERY_AES_256_GCMSIV_HASWELL_NONCE_LEN] = {0};
  unsigned char tag[HABERDASHERY_AES_256_GCMSIV_HASWELL_TAG_LEN] = {0};
