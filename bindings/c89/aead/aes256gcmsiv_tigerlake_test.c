...
#include "aes256gcmsiv_tigerlake.h"

int main(void) {
  haberdashery_aes256gcmsiv_tigerlake_t aead;
  unsigned char key[HABERDASHERY_AES_256_GCMSIV_TIGERLAKE_KEY_LEN] = {0};
  unsigned char nonce[HABERDASHERY_AES_256_GCMSIV_TIGERLAKE_NONCE_LEN] = {0};
  unsigned char tag[HABERDASHERY_AES_256_GCMSIV_TIGERLAKE_TAG_LEN] = {0};
