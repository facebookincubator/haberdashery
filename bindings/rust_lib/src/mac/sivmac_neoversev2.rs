...
use haberdashery_sys::mac::sivmac_neoversev2::*;
pub use haberdashery_sys::mac::sivmac_neoversev2::SivMac;
...
impl Mac for SivMac {
    ...
    const FN_SIGN: unsafe extern "C" fn(
        ...
        tag: *mut u8,
        tag_len: usize,
    ) -> i32 = haberdashery_sivmac_neoversev2_sign;
    const FN_VERIFY: unsafe extern "C" fn(
        ...
        tag: *const u8,
        tag_len: usize,
    ) -> i32 = haberdashery_sivmac_neoversev2_verify;
