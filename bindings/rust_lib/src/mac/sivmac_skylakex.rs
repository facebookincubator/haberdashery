...
use haberdashery_sys::mac::sivmac_skylakex::*;
pub use haberdashery_sys::mac::sivmac_skylakex::SivMac;
...
impl Mac for SivMac {
    ...
    const FN_SIGN: unsafe extern "C" fn(
        ...
        tag: *mut u8,
        tag_len: usize,
    ) -> i32 = haberdashery_sivmac_skylakex_sign;
    const FN_VERIFY: unsafe extern "C" fn(
        ...
        tag: *const u8,
        tag_len: usize,
    ) -> i32 = haberdashery_sivmac_skylakex_verify;
