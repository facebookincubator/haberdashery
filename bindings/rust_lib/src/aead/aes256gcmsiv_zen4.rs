...
use haberdashery_sys::aead::aes256gcmsiv_zen4::*;
pub use haberdashery_sys::aead::aes256gcmsiv_zen4::Aes256Gcmsiv;
...
impl Aead for Aes256Gcmsiv {
    ...
    const FN_ENCRYPT: unsafe extern "C" fn(
        ...
        tag: *mut u8,
        tag_len: usize,
    ) -> i32 = haberdashery_aes256gcmsiv_zen4_encrypt;
    const FN_DECRYPT: unsafe extern "C" fn(
        ...
        plaintext: *mut u8,
        plaintext_len: usize,
    ) -> i32 = haberdashery_aes256gcmsiv_zen4_decrypt;
