...
use haberdashery_sys::aead::aes256gcmsiv_haswell::*;
pub use haberdashery_sys::aead::aes256gcmsiv_haswell::Aes256Gcmsiv;
...
impl Aead for Aes256Gcmsiv {
    ...
    const FN_ENCRYPT: unsafe extern "C" fn(
        ...
        tag: *mut u8,
        tag_len: usize,
    ) -> i32 = haberdashery_aes256gcmsiv_haswell_encrypt;
    const FN_DECRYPT: unsafe extern "C" fn(
        ...
        plaintext: *mut u8,
        plaintext_len: usize,
    ) -> i32 = haberdashery_aes256gcmsiv_haswell_decrypt;
