...
use haberdashery_sys::aead::aes128gcm_skylake::*;
pub use haberdashery_sys::aead::aes128gcm_skylake::Aes128Gcm;
...
impl Aead for Aes128Gcm {
    ...
    const FN_ENCRYPT: unsafe extern "C" fn(
        ...
        tag: *mut u8,
        tag_len: usize,
    ) -> i32 = haberdashery_aes128gcm_skylake_encrypt;
    const FN_DECRYPT: unsafe extern "C" fn(
        ...
        plaintext: *mut u8,
        plaintext_len: usize,
    ) -> i32 = haberdashery_aes128gcm_skylake_decrypt;
