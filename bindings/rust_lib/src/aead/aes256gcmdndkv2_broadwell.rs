...
use haberdashery_sys::aead::aes256gcmdndkv2_broadwell::*;
pub use haberdashery_sys::aead::aes256gcmdndkv2_broadwell::Aes256Gcmdndkv2;
...
impl Aead for Aes256Gcmdndkv2 {
    ...
    const FN_ENCRYPT: unsafe extern "C" fn(
        ...
        tag: *mut u8,
        tag_len: usize,
    ) -> i32 = haberdashery_aes256gcmdndkv2_broadwell_encrypt;
    const FN_DECRYPT: unsafe extern "C" fn(
        ...
        plaintext: *mut u8,
        plaintext_len: usize,
    ) -> i32 = haberdashery_aes256gcmdndkv2_broadwell_decrypt;
