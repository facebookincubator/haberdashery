...
use haberdashery_sys::aead::aes256gcmdndkv2kc_skylakex::*;
pub use haberdashery_sys::aead::aes256gcmdndkv2kc_skylakex::Aes256Gcmdndkv2Kc;
...
impl Aead for Aes256Gcmdndkv2Kc {
    ...
    const FN_ENCRYPT: unsafe extern "C" fn(
        ...
        tag: *mut u8,
        tag_len: usize,
    ) -> i32 = haberdashery_aes256gcmdndkv2kc_skylakex_encrypt;
    const FN_DECRYPT: unsafe extern "C" fn(
        ...
        plaintext: *mut u8,
        plaintext_len: usize,
    ) -> i32 = haberdashery_aes256gcmdndkv2kc_skylakex_decrypt;
