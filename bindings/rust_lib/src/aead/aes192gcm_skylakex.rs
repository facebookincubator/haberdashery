...
use haberdashery_sys::aead::aes192gcm_skylakex::*;
pub use haberdashery_sys::aead::aes192gcm_skylakex::Aes192Gcm;
...
impl Aead for Aes192Gcm {
    ...
    const FN_ENCRYPT: unsafe extern "C" fn(
        ...
        tag: *mut u8,
        tag_len: usize,
    ) -> i32 = haberdashery_aes192gcm_skylakex_encrypt;
    const FN_DECRYPT: unsafe extern "C" fn(
        ...
        plaintext: *mut u8,
        plaintext_len: usize,
    ) -> i32 = haberdashery_aes192gcm_skylakex_decrypt;
