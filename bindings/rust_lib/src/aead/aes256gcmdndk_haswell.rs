...
use haberdashery_sys::aead::aes256gcmdndk_haswell::*;
pub use haberdashery_sys::aead::aes256gcmdndk_haswell::Aes256Gcmdndk;
...
impl Aead for Aes256Gcmdndk {
    ...
    const FN_ENCRYPT: unsafe extern "C" fn(
        ...
        tag: *mut u8,
        tag_len: usize,
    ) -> i32 = haberdashery_aes256gcmdndk_haswell_encrypt;
    const FN_DECRYPT: unsafe extern "C" fn(
        ...
        plaintext: *mut u8,
        plaintext_len: usize,
    ) -> i32 = haberdashery_aes256gcmdndk_haswell_decrypt;
