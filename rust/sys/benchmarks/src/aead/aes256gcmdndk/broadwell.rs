...
use haberdashery_sys::aead::aes256gcmdndk::broadwell::*;
...
const VTABLE: Vtable<Aes256GcmDndk> = Vtable::<Aes256GcmDndk> {
    ...
    init: haberdashery_aes256gcmdndk_broadwell_init,
    encrypt: haberdashery_aes256gcmdndk_broadwell_encrypt,
    decrypt: haberdashery_aes256gcmdndk_broadwell_decrypt,
};
...
fn init(iters: u64, measure: &mut dyn Measure) {
    if unsafe { 0 == haberdashery_aes256gcmdndk_broadwell_is_supported() } {
        measure.skip();
        return;
    }
