...
use haberdashery_sys::aead::aes256gcmdndk::haswell::*;
...
const VTABLE: Vtable<Aes256GcmDndk> = Vtable::<Aes256GcmDndk> {
    ...
    init: haberdashery_aes256gcmdndk_haswell_init,
    encrypt: haberdashery_aes256gcmdndk_haswell_encrypt,
    decrypt: haberdashery_aes256gcmdndk_haswell_decrypt,
};
...
fn init(iters: u64, measure: &mut dyn Measure) {
    if unsafe { 0 == haberdashery_aes256gcmdndk_haswell_is_supported() } {
        measure.skip();
        return;
    }
