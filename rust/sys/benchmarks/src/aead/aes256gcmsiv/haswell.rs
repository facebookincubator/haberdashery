...
use haberdashery_sys::aead::aes256gcmsiv::haswell::*;
...
const VTABLE: Vtable<Aes256GcmSiv> = Vtable::<Aes256GcmSiv> {
    ...
    init: haberdashery_aes256gcmsiv_haswell_init,
    encrypt: haberdashery_aes256gcmsiv_haswell_encrypt,
    decrypt: haberdashery_aes256gcmsiv_haswell_decrypt,
};
...
fn init(iters: u64, measure: &mut dyn Measure) {
    if unsafe { 0 == haberdashery_aes256gcmsiv_haswell_is_supported() } {
        measure.skip();
        return;
    }
