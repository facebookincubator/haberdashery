...
const VTABLE: Vtable<Rr11AesPcm> = Vtable::<Rr11AesPcm> {
    ...
    init: haberdashery_rr11aespcm_skylake_init,
    encrypt: haberdashery_rr11aespcm_skylake_encrypt,
    decrypt: haberdashery_rr11aespcm_skylake_decrypt,
};
...
fn init(iters: u64, measure: &mut dyn Measure) {
    if unsafe { 0 == haberdashery_rr11aespcm_skylake_is_supported() } {
        measure.skip();
        return;
    }
