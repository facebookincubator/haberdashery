...
use haberdashery_sys::aead::aes256gcm::haswell::*;
...
const VTABLE: Vtable<Aes256Gcm> = Vtable::<Aes256Gcm> {
    ...
    init: haberdashery_aes256gcm_haswell_init,
    encrypt: haberdashery_aes256gcm_haswell_encrypt,
    decrypt: haberdashery_aes256gcm_haswell_decrypt,
};
...
fn init(iters: u64, measure: &mut dyn Measure) {
    if unsafe { 0 == haberdashery_aes256gcm_haswell_is_supported() } {
        measure.skip();
        return;
    }
