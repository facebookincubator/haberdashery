...
use crate::aes128gcm::Aes128GcmKey as BaseKey;
use crate::aes128gcm::Aes128GcmState as BaseState;
use crate::ffi::aead_streaming::AeadStreaming;
...
#[repr(C)]
pub struct Aes128GcmKey(BaseKey<LANES>);
#[repr(C)]
pub struct Aes128GcmState(BaseState<LANES>);
...
impl AeadStreaming for Aes128GcmState {
    const KEY_LEN: usize = 16;
    const NONCE_LEN: usize = 12;
    const TAG_LEN: usize = 16;
    const KEY_STRUCT_SIZE: usize = 272;
