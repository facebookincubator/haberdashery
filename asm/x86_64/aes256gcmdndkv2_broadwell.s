...
haberdashery_aes256gcmdndkv2_broadwell_encrypt:
	...
	vpclmulqdq	$1, %xmm12, %xmm11, %xmm1
	vpxor	%xmm0, %xmm1, %xmm0
	vpclmulqdq	$0, %xmm12, %xmm11, %xmm1
	vpslldq	$8, %xmm0, %xmm2
	vpxor	%xmm2, %xmm1, %xmm1
	vpclmulqdq	$16, %xmm3, %xmm1, %xmm2
	vpshufd	$78, %xmm1, %xmm1
...
.LBB1_29:
	...
	#NO_APP
	vpxor	(%r9), %xmm1, %xmm3
	vpxor	16(%r9), %xmm2, %xmm0
	vpxor	32(%r9), %xmm4, %xmm1
	vmovdqa	%xmm0, %xmm4
	vpxor	48(%r9), %xmm5, %xmm10
	vpxor	64(%r9), %xmm6, %xmm12
	vmovdqa	%xmm1, %xmm6
...
.LBB1_36:
	...
	vpshufb	%xmm15, %xmm6, %xmm6
	vpaddd	.LCPI1_19(%rip), %xmm9, %xmm11
	vpshufb	%xmm15, %xmm11, %xmm11
	vpaddd	.LCPI1_20(%rip), %xmm9, %xmm13
	vpshufb	%xmm15, %xmm13, %xmm7
	vpshufb	%xmm15, %xmm3, %xmm3
	...
	vpxor	%xmm7, %xmm4, %xmm4
	#NO_APP
	vpshufb	.LCPI1_13(%rip), %xmm8, %xmm0
	vmovaps	96(%rsp), %xmm3
	#APP
	vaesenc	%xmm3, %xmm13, %xmm13
	vaesenc	%xmm3, %xmm14, %xmm14
	...
	vpxor	16(%rax), %xmm14, %xmm4
	vpxor	32(%rax), %xmm15, %xmm6
	vmovdqa	.LCPI1_13(%rip), %xmm15
	vpxor	48(%rax), %xmm1, %xmm10
	vpxor	64(%rax), %xmm2, %xmm12
...
.LBB1_34:
	...
	vmovdqa	(%rsp), %xmm5
.LBB1_38:
	vpshufb	%xmm15, %xmm3, %xmm0
	vpxor	%xmm0, %xmm5, %xmm2
	vpshufb	%xmm15, %xmm4, %xmm3
	vpshufb	%xmm15, %xmm6, %xmm0
	vpshufb	%xmm15, %xmm10, %xmm4
	vpshufb	%xmm15, %xmm12, %xmm5
	vpshufb	%xmm15, %xmm1, %xmm1
	vmovdqa	64(%rsp), %xmm12
	vpclmulqdq	$0, %xmm1, %xmm12, %xmm6
	vpclmulqdq	$1, %xmm1, %xmm12, %xmm7
	vpclmulqdq	$16, %xmm1, %xmm12, %xmm8
	vpxor	%xmm7, %xmm8, %xmm7
...
.LBB1_41:
	...
	movq	%r12, %r8
.LBB1_44:
	vpbroadcastq	.LCPI1_26(%rip), %xmm15
	vmovdqa	64(%rsp), %xmm12
	vmovdqa	240(%rsp), %xmm10
	vpshufb	.LCPI1_13(%rip), %xmm0, %xmm0
	vpxor	(%rsp), %xmm0, %xmm0
