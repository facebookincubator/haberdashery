...
haberdashery_aes256gcmsiv_skylakex_decrypt:
	...
	vaesenclast	%xmm5, %xmm4, %xmm13
	vpternlogq	$150, %xmm2, %xmm31, %xmm13
	vpslldq	$4, %xmm6, %xmm2
	...
	vaesenclast	%xmm2, %xmm0, %xmm12
	vpternlogq	$150, %xmm4, %xmm13, %xmm12
	...
	vmovdqa	%xmm9, %xmm8
	vmovdqa	%xmm9, -96(%rsp)
	vpslldq	$4, %xmm22, %xmm0
	vpslldq	$8, %xmm22, %xmm6
	vpslldq	$12, %xmm22, %xmm7
	vpternlogq	$150, %xmm6, %xmm0, %xmm7
	vpshufd	$255, %xmm9, %xmm0
	vaesenclast	%xmm1, %xmm0, %xmm14
	vpternlogq	$150, %xmm7, %xmm22, %xmm14
	...
	vpshufd	$255, %xmm15, %xmm0
	vaesenclast	%xmm1, %xmm0, %xmm8
	vpternlogq	$150, %xmm9, %xmm14, %xmm8
	vpsrldq	$8, %xmm2, %xmm0
...
.LBB2_23:
	...
	vpclmulqdq	$1, -32(%rsp), %xmm2, %xmm10
	vpternlogq	$150, %xmm9, %xmm6, %xmm10
	vpclmulqdq	$0, %xmm0, %xmm11, %xmm6
...
.LBB2_7:
	...
	vpshufb	%xmm17, %xmm8, %xmm5
	vmovddup	.LCPI2_12(%rip), %xmm7
	movq	296(%rsp), %rdx
	cmpq	$16, %rax
...
.LBB2_11:
	...
	vmovq	%r8, %xmm18
	movq	312(%rsp), %rdx
	vpternlogq	$150, %xmm0, %xmm14, %xmm11
	vporq	.LCPI2_14(%rip), %xmm24, %xmm23
	cmpq	$96, %r10
	...
	vmovdqa64	%xmm16, 224(%rsp)
	vmovdqa64	%xmm30, 128(%rsp)
	vmovdqa64	-80(%rsp), %xmm19
	vmovdqa64	%xmm9, %xmm25
	vmovaps	-48(%rsp), %xmm30
	vmovaps	-128(%rsp), %xmm27
	...
	vmovaps	-32(%rsp), %xmm28
	vmovdqa64	32(%rsp), %xmm20
	vmovdqa	%xmm15, 64(%rsp)
	vmovaps	-16(%rsp), %xmm29
	vmovaps	%xmm3, 96(%rsp)
	.p2align	4
.LBB2_29:
	...
	vpxor	%xmm4, %xmm9, %xmm4
	vpclmulqdq	$17, %xmm10, %xmm1, %xmm9
	vpxor	%xmm5, %xmm9, %xmm5
	vpclmulqdq	$1, %xmm10, %xmm1, %xmm9
	vpxor	%xmm9, %xmm15, %xmm15
	#NO_APP
	vmovaps	80(%rsp), %xmm1
	#APP
	...
	vpunpcklqdq	%xmm15, %xmm3, %xmm1
	vpunpckhqdq	%xmm3, %xmm15, %xmm6
...
.LBB2_27:
	...
	vpclmulqdq	$1, %xmm11, %xmm15, %xmm0
	vpclmulqdq	$16, %xmm11, %xmm15, %xmm4
	vpternlogq	$150, %xmm0, %xmm6, %xmm4
	vpclmulqdq	$17, %xmm10, %xmm7, %xmm0
	vpclmulqdq	$17, %xmm11, %xmm15, %xmm6
	vpxorq	%xmm1, %xmm22, %xmm1
	...
	vpclmulqdq	$16, %xmm9, %xmm4, %xmm1
	vpshufd	$78, %xmm4, %xmm2
	vpxor	%xmm2, %xmm1, %xmm2
	vpclmulqdq	$16, %xmm9, %xmm2, %xmm1
	...
	movq	%rcx, %r9
	vmovdqa64	%xmm21, %xmm23
	vmovapd	176(%rsp), %xmm13
	vmovapd	160(%rsp), %xmm10
