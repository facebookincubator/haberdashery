...
haberdashery_aes256gcmdndkv2kc_broadwell_encrypt:
	...
	vpxor	%xmm7, %xmm6, %xmm6
	vpxor	%xmm6, %xmm14, %xmm6
	vpshufb	%xmm4, %xmm15, %xmm12
	vaesenclast	%xmm5, %xmm12, %xmm12
	vpxor	%xmm6, %xmm12, %xmm12
	#NO_APP
	vmovdqa	%xmm12, %xmm7
	vpslldq	$4, %xmm15, %xmm4
	vpunpcklqdq	%xmm15, %xmm10, %xmm5
	vpxor	%xmm5, %xmm4, %xmm4
	vinsertps	$55, %xmm15, %xmm0, %xmm5
	vpxor	%xmm5, %xmm4, %xmm4
	vpshufd	$255, %xmm12, %xmm5
	vaesenclast	%xmm10, %xmm5, %xmm5
	vpxor	%xmm4, %xmm15, %xmm4
	vpxor	%xmm4, %xmm5, %xmm6
	vpslldq	$4, %xmm12, %xmm4
	vpunpcklqdq	%xmm12, %xmm10, %xmm5
	vpxor	%xmm5, %xmm4, %xmm4
	vinsertps	$55, %xmm12, %xmm0, %xmm5
	vpxor	%xmm5, %xmm4, %xmm4
	vmovdqa	%xmm6, %xmm5
	...
	vpclmulqdq	$17, %xmm12, %xmm12, %xmm3
	vpshufd	$78, %xmm2, %xmm4
	vpxor	%xmm4, %xmm3, %xmm3
	vpclmulqdq	$16, %xmm6, %xmm2, %xmm2
	vpxor	%xmm2, %xmm3, %xmm14
	vpclmulqdq	$16, %xmm12, %xmm14, %xmm2
	vpclmulqdq	$1, %xmm12, %xmm14, %xmm3
	vpxor	%xmm2, %xmm3, %xmm2
	vpclmulqdq	$0, %xmm12, %xmm14, %xmm3
	vpslldq	$8, %xmm2, %xmm4
	vpxor	%xmm4, %xmm3, %xmm3
	...
	vpsrldq	$8, %xmm2, %xmm2
	vpclmulqdq	$17, %xmm12, %xmm14, %xmm4
	vpxor	%xmm2, %xmm4, %xmm2
	...
	vpclmulqdq	$16, %xmm12, %xmm11, %xmm2
	vpclmulqdq	$1, %xmm12, %xmm11, %xmm3
	vpxor	%xmm2, %xmm3, %xmm2
	vpclmulqdq	$0, %xmm12, %xmm11, %xmm3
	vpslldq	$8, %xmm2, %xmm4
	vpxor	%xmm4, %xmm3, %xmm3
	vpclmulqdq	$16, %xmm6, %xmm3, %xmm4
	vpshufd	$78, %xmm3, %xmm3
...
.LBB1_32:
	...
	vpxor	32(%r9), %xmm4, %xmm12
	vpxor	48(%r9), %xmm5, %xmm2
	vmovdqa	%xmm1, %xmm5
	vpxor	64(%r9), %xmm6, %xmm10
	vmovdqa	%xmm2, %xmm6
...
.LBB1_39:
	...
	vmovdqa	%xmm5, 32(%rsp)
	vmovdqa	.LCPI1_15(%rip), %xmm12
	vpshufb	%xmm12, %xmm9, %xmm2
	vmovdqa	%xmm4, %xmm0
	...
	vpxor	16(%rax), %xmm14, %xmm5
	vpxor	32(%rax), %xmm15, %xmm12
	vpxor	48(%rax), %xmm1, %xmm6
	vpxor	64(%rax), %xmm2, %xmm10
	vpxor	80(%rax), %xmm11, %xmm1
	addq	$96, %rax
	vmovdqu	%xmm3, (%rcx)
	vmovdqu	%xmm5, 16(%rcx)
...
.LBB1_42:
	...
	.p2align	4
.LBB1_43:
	vmovdqa	.LCPI1_15(%rip), %xmm13
	vpshufb	%xmm13, %xmm1, %xmm2
	vpxor	208(%rsp), %xmm2, %xmm2
	vaesenc	%xmm15, %xmm2, %xmm2
	vaesenc	%xmm14, %xmm2, %xmm2
	vaesenc	%xmm11, %xmm2, %xmm2
	vaesenc	%xmm12, %xmm2, %xmm2
...
haberdashery_aes256gcmdndkv2kc_broadwell_decrypt:
	...
	vaesenc	%xmm11, %xmm0, %xmm0
	vaesenc	%xmm13, %xmm0, %xmm0
	vpxor	16(%r12), %xmm2, %xmm1
	vaesenclast	%xmm14, %xmm0, %xmm0
	vmovdqa	(%rsp), %xmm2
	vpxor	%xmm2, %xmm1, %xmm1
	vpxor	32(%r12), %xmm0, %xmm0
	vpxor	%xmm2, %xmm0, %xmm0
	vpor	%xmm1, %xmm0, %xmm0
	vptest	%xmm0, %xmm0
	jne	.LBB2_45
