...
haberdashery_aes256gcmdndk_broadwell_encrypt:
	...
	vpmovsxbq	.LCPI1_29(%rip), %xmm3
	vxorps	%xmm3, %xmm0, %xmm2
	vmovaps	%xmm3, (%rsp)
	vxorps	%xmm3, %xmm1, %xmm3
	vpmovsxbq	.LCPI1_30(%rip), %xmm5
	...
	vpbroadcastq	.LCPI1_31(%rip), %xmm10
	...
	vpclmulqdq	$16, %xmm11, %xmm6, %xmm0
	vpclmulqdq	$1, %xmm11, %xmm6, %xmm1
	vpxor	%xmm0, %xmm1, %xmm0
	...
	vpxor	%xmm1, %xmm2, %xmm1
	vpsrldq	$8, %xmm0, %xmm0
	vpclmulqdq	$17, %xmm11, %xmm13, %xmm2
	vpxor	%xmm0, %xmm2, %xmm0
	vpshufd	$78, %xmm1, %xmm2
	vpxor	%xmm2, %xmm0, %xmm0
	vpclmulqdq	$16, %xmm10, %xmm1, %xmm1
...
.LBB1_24:
	...
	vpsrldq	$8, %xmm2, %xmm2
	vpxor	%xmm2, %xmm3, %xmm2
	vpbroadcastq	.LCPI1_31(%rip), %xmm9
...
.LBB1_35:
	...
	leaq	96(%r9), %rax
	leaq	96(%rdx), %rcx
	vpxor	.LCPI1_14(%rip), %xmm12, %xmm0
	vpxor	.LCPI1_15(%rip), %xmm12, %xmm1
	vpxor	.LCPI1_16(%rip), %xmm12, %xmm2
	vpxor	.LCPI1_17(%rip), %xmm12, %xmm4
	vmovdqa	%xmm5, %xmm11
	vpxor	.LCPI1_18(%rip), %xmm12, %xmm5
	vpxor	.LCPI1_19(%rip), %xmm12, %xmm6
	#APP
	...
	#NO_APP
	vpxor	(%r9), %xmm0, %xmm3
	vpxor	16(%r9), %xmm1, %xmm9
	vpxor	32(%r9), %xmm2, %xmm10
	vpxor	48(%r9), %xmm4, %xmm11
	vpxor	64(%r9), %xmm5, %xmm0
	vpxor	80(%r9), %xmm6, %xmm1
	vmovdqa	%xmm0, %xmm6
	vmovdqu	%xmm3, (%rdx)
	vmovdqu	%xmm9, 16(%rdx)
...
.LBB1_37:
	...
	vmovdqa	%xmm6, %xmm0
	vmovdqa	(%rsp), %xmm6
	vpaddd	.LCPI1_22(%rip), %xmm6, %xmm6
	vpshufb	%xmm9, %xmm6, %xmm6
	vmovdqa	(%rsp), %xmm7
	vpaddd	.LCPI1_2(%rip), %xmm7, %xmm12
	vpshufb	%xmm9, %xmm12, %xmm12
	vmovdqa	(%rsp), %xmm7
	vpaddd	.LCPI1_23(%rip), %xmm7, %xmm13
	vpshufb	%xmm9, %xmm13, %xmm7
	...
	vpclmulqdq	$16, %xmm10, %xmm8, %xmm7
	vpxor	%xmm7, %xmm5, %xmm5
	vpclmulqdq	$0, %xmm10, %xmm8, %xmm7
	vpxor	%xmm7, %xmm4, %xmm4
	vpclmulqdq	$17, %xmm10, %xmm8, %xmm7
	vpxor	%xmm7, %xmm6, %xmm6
	vpclmulqdq	$1, %xmm10, %xmm8, %xmm7
	vpxor	%xmm7, %xmm5, %xmm5
	#NO_APP
	vpshufb	%xmm9, %xmm0, %xmm7
	...
	vpxor	%xmm4, %xmm6, %xmm4
	vpbroadcastq	.LCPI1_31(%rip), %xmm6
	...
	vpxor	16(%rax), %xmm14, %xmm9
	vpxor	32(%rax), %xmm15, %xmm10
	vpxor	48(%rax), %xmm1, %xmm11
	vpxor	64(%rax), %xmm2, %xmm6
...
.LBB1_39:
	...
	vpshufb	%xmm4, %xmm9, %xmm2
	vpshufb	%xmm4, %xmm10, %xmm3
...
.LBB1_26:
	...
	vmovaps	160(%rsp), %xmm15
	vmovdqa	144(%rsp), %xmm8
	vpbroadcastq	.LCPI1_31(%rip), %xmm4
	vmovdqa	80(%rsp), %xmm11
...
.LBB1_41:
	...
	leaq	16(%rdx), %r14
	addq	$-16, %rbx
	vpaddd	.LCPI1_21(%rip), %xmm13, %xmm13
	movq	%r14, %rdx
	movq	%rsi, %r9
	cmpq	$15, %rbx
	ja	.LBB1_41
...
haberdashery_aes256gcmdndk_broadwell_decrypt:
	...
	vxorps	%xmm0, %xmm2, %xmm0
	vxorps	%xmm1, %xmm2, %xmm1
	vpmovsxbq	.LCPI2_22(%rip), %xmm15
	vxorps	%xmm0, %xmm15, %xmm2
	vxorps	%xmm1, %xmm15, %xmm3
	vpmovsxbq	.LCPI2_23(%rip), %xmm5
	vxorps	%xmm5, %xmm0, %xmm4
	vxorps	%xmm5, %xmm1, %xmm5
	vmovaps	16(%rdi), %xmm6
	#APP
...
.LBB2_32:
	...
	vpbroadcastq	.LCPI2_24(%rip), %xmm7
	vpxor	%xmm5, %xmm6, %xmm5
