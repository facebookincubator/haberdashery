...
.LBB1_29:
	movq	184(%rsp), %rdx
	vpshufb	.LCPI1_14(%rip), %xmm29, %xmm1
	vpaddd	.LCPI1_15(%rip), %xmm1, %xmm17
	cmpq	$96, %r10
	jb	.LBB1_30
	...
	vmovdqa	%xmm6, %xmm9
	vpaddd	.LCPI1_18(%rip), %xmm1, %xmm6
	vpshufb	%xmm18, %xmm6, %xmm6
	vmovdqa64	%xmm11, %xmm20
	vpaddd	.LCPI1_19(%rip), %xmm1, %xmm11
	...
	leaq	96(%r9), %r9
	leaq	96(%rdx), %rcx
	vpaddd	.LCPI1_21(%rip), %xmm1, %xmm17
	vmovdqu64	%xmm19, (%rdx)
...
.LBB1_35:
	vpshufb	%xmm18, %xmm17, %xmm0
	vpaddd	.LCPI1_15(%rip), %xmm17, %xmm1
	vpshufb	%xmm18, %xmm1, %xmm1
	vpaddd	.LCPI1_16(%rip), %xmm17, %xmm3
	vpshufb	%xmm18, %xmm3, %xmm3
	vpaddd	.LCPI1_17(%rip), %xmm17, %xmm6
	...
	addq	$96, %rcx
	addq	$-96, %rax
	vpaddd	.LCPI1_20(%rip), %xmm17, %xmm17
	cmpq	$95, %rax
	ja	.LBB1_35
...
.LBB1_40:
	...
	vpshufb	.LCPI1_12(%rip), %xmm17, %xmm1
...
.LBB1_43:
	...
	vpshufb	.LCPI1_12(%rip), %xmm0, %xmm0
	vpshufb	.LCPI1_22(%rip), %xmm2, %xmm2
	vpxor	%xmm2, %xmm0, %xmm0
...
haberdashery_aes256gcmdndkv2_tigerlake_decrypt:
	...
	vaesenclast	%xmm3, %xmm11, %xmm11
	vpternlogq	$150, %xmm0, %xmm7, %xmm11
	#NO_APP
	#APP
	vaesenc	%xmm15, %xmm1, %xmm1
	vpslldq	$4, %xmm15, %xmm3
	...
	vpternlogq	$150, %xmm4, %xmm14, %xmm7
	...
	vpternlogq	$150, %xmm0, %xmm3, %xmm4
	vpclmulqdq	$0, %xmm4, %xmm4, %xmm0
	vpbroadcastq	.LCPI2_13(%rip), %xmm31
...
.LBB2_21:
	...
	vpclmulqdq	$0, %xmm11, %xmm22, %xmm15
	vpclmulqdq	$1, %xmm11, %xmm22, %xmm17
	vpclmulqdq	$16, %xmm11, %xmm22, %xmm18
	vpternlogq	$150, %xmm17, %xmm14, %xmm18
	vpclmulqdq	$17, %xmm11, %xmm22, %xmm11
	vpclmulqdq	$0, %xmm5, %xmm27, %xmm14
	vpternlogq	$150, %xmm13, %xmm15, %xmm14
	vpclmulqdq	$1, %xmm5, %xmm27, %xmm13
	vpclmulqdq	$16, %xmm5, %xmm27, %xmm15
	...
	vpternlogq	$150, %xmm3, %xmm5, %xmm2
	vpclmulqdq	$0, %xmm1, %xmm29, %xmm3
	vpclmulqdq	$1, %xmm1, %xmm29, %xmm5
	vpclmulqdq	$16, %xmm1, %xmm29, %xmm11
...
.LBB2_30:
	movq	168(%rsp), %rax
	vpshufb	.LCPI2_14(%rip), %xmm25, %xmm0
	vpaddd	.LCPI2_15(%rip), %xmm0, %xmm17
	cmpq	$96, %r10
	jb	.LBB2_31
...
.LBB2_39:
	...
	vpshufb	%xmm18, %xmm17, %xmm0
	vpaddd	.LCPI2_15(%rip), %xmm17, %xmm1
	vpshufb	%xmm18, %xmm1, %xmm1
	vpaddd	.LCPI2_16(%rip), %xmm17, %xmm2
	...
	vpshufb	%xmm18, %xmm2, %xmm19
	vpshufb	%xmm18, %xmm30, %xmm8
	vpxorq	%xmm0, %xmm16, %xmm2
	vpxorq	%xmm1, %xmm16, %xmm3
	vpxorq	%xmm11, %xmm16, %xmm14
	vpxorq	%xmm12, %xmm16, %xmm13
	vpxorq	%xmm15, %xmm16, %xmm1
	vpxorq	%xmm19, %xmm16, %xmm11
	vmovaps	16(%rsp), %xmm0
	#APP
	...
	addq	$96, %rax
	addq	$-96, %rcx
	vpaddd	.LCPI2_20(%rip), %xmm17, %xmm17
	cmpq	$95, %rcx
	ja	.LBB2_39
	vmovapd	16(%rsp), %xmm8
	vmovdqa	(%rsp), %xmm12
...
.LBB2_42:
	...
	vaesenc	%xmm21, %xmm3, %xmm3
	vaesenc	%xmm14, %xmm3, %xmm3
	vaesenclast	%xmm22, %xmm3, %xmm3
	vpxor	%xmm2, %xmm3, %xmm2
	vmovdqu	%xmm2, (%rax)
	movq	%rdx, %rax
	cmpq	$15, %rcx
...
.LBB2_35:
	...
	vpshufb	.LCPI2_12(%rip), %xmm17, %xmm0
...
.LBB2_27:
	...
	vaesenc	%xmm14, %xmm3, %xmm3
	vpshufb	.LCPI2_21(%rip), %xmm1, %xmm1
