...
haberdashery_aes256gcmdndk_skylake_encrypt:
	...
	vpxor	%xmm3, %xmm2, %xmm2
	vpshufb	.LCPI1_3(%rip), %xmm12, %xmm0
	...
	vpclmulqdq	$16, %xmm14, %xmm11, %xmm0
	vpclmulqdq	$1, %xmm14, %xmm11, %xmm1
	vpxor	%xmm0, %xmm1, %xmm0
	vpclmulqdq	$0, %xmm14, %xmm11, %xmm1
	vpslldq	$8, %xmm0, %xmm2
	vpxor	%xmm2, %xmm1, %xmm1
	vpclmulqdq	$16, %xmm13, %xmm1, %xmm2
	vpshufd	$78, %xmm1, %xmm1
...
.LBB1_37:
	...
	leaq	16(%rax), %r12
	addq	$-16, %r15
	vpaddd	.LCPI1_21(%rip), %xmm12, %xmm12
	movq	%rsi, %r14
	movq	%r12, %rax
	cmpq	$15, %r15
	ja	.LBB1_37
...
.LBB1_10:
	...
	vpxor	%xmm7, %xmm6, %xmm6
	vpclmulqdq	$0, %xmm1, %xmm11, %xmm7
	vpxor	%xmm7, %xmm5, %xmm5
	vpclmulqdq	$16, %xmm2, %xmm8, %xmm7
	vpxor	%xmm4, %xmm5, %xmm4
	vpclmulqdq	$1, %xmm1, %xmm11, %xmm5
	vpxor	%xmm5, %xmm7, %xmm5
...
.LBB1_34:
	...
	vpaddd	.LCPI1_23(%rip), %xmm0, %xmm13
	...
	vaesenclast	%xmm5, %xmm4, %xmm4
	#NO_APP
	vpxor	(%r14), %xmm13, %xmm9
	vpxor	16(%r14), %xmm14, %xmm10
	vpxor	32(%r14), %xmm15, %xmm15
...
haberdashery_aes256gcmdndk_skylake_decrypt:
	...
	vpclmulqdq	$16, %xmm8, %xmm12, %xmm0
	vpclmulqdq	$1, %xmm8, %xmm12, %xmm1
	vpxor	%xmm0, %xmm1, %xmm0
	vpclmulqdq	$0, %xmm8, %xmm12, %xmm1
	vpslldq	$8, %xmm0, %xmm2
	vpxor	%xmm2, %xmm1, %xmm1
	vpclmulqdq	$16, %xmm10, %xmm1, %xmm2
	vpshufd	$78, %xmm1, %xmm1
...
.LBB2_37:
	...
	vpaddd	.LCPI2_14(%rip), %xmm12, %xmm2
	vpshufb	%xmm0, %xmm2, %xmm2
	vpaddd	.LCPI2_1(%rip), %xmm12, %xmm3
	vpshufb	%xmm0, %xmm3, %xmm3
	vpaddd	.LCPI2_15(%rip), %xmm12, %xmm4
	vpshufb	%xmm0, %xmm4, %xmm4
	vpaddd	.LCPI2_2(%rip), %xmm12, %xmm5
	...
	vpxor	%xmm5, %xmm6, %xmm5
	vpclmulqdq	$16, .LCPI2_13(%rip), %xmm4, %xmm6
	vpshufd	$78, %xmm4, %xmm4
	vpxor	%xmm4, %xmm6, %xmm4
	...
	vmovups	%xmm1, 32(%rax)
	vmovdqu	%xmm2, 48(%rax)
	vxorps	464(%rsp), %xmm13, %xmm1
	vmovdqa	176(%rsp), %xmm13
	vpbroadcastq	.LCPI2_22(%rip), %xmm10
	vmovdqu	%xmm3, 64(%rax)
	vmovups	%xmm1, 80(%rax)
	vpclmulqdq	$16, %xmm10, %xmm4, %xmm1
	vpxor	%xmm1, %xmm5, %xmm0
	addq	$96, %r14
	addq	$96, %rax
	addq	$-96, %r15
	vpaddd	.LCPI2_17(%rip), %xmm12, %xmm12
	cmpq	$96, %r15
	jae	.LBB2_37
	vmovdqa	%xmm0, (%rsp)
	vmovdqa	%xmm12, 16(%rsp)
