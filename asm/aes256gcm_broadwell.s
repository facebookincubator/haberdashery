...
.LBB1_27:
	...
	leaq	16(%rax), %r13
	addq	$-16, %r12
	vpaddd	.LCPI1_2(%rip), %xmm11, %xmm11
	movq	%rsi, %r15
	movq	%r13, %rax
	cmpq	$15, %r12
	ja	.LBB1_27
...
.LBB1_28:
	...
	vpaddd	.LCPI1_9(%rip), %xmm1, %xmm11
	vmovdqa	(%rbx), %xmm1
	vmovaps	16(%rbx), %xmm0
	vmovaps	32(%rbx), %xmm10
	vmovaps	48(%rbx), %xmm12
	...
	vaesenc	%xmm0, %xmm8, %xmm8
	#NO_APP
	vmovaps	80(%rbx), %xmm13
	vmovaps	%xmm13, 432(%rsp)
	#APP
	...
	#NO_APP
	vmovaps	96(%rbx), %xmm13
	vmovaps	%xmm13, 416(%rsp)
	#APP
	vaesenc	%xmm13, %xmm2, %xmm2
	vaesenc	%xmm13, %xmm3, %xmm3
	vaesenc	%xmm13, %xmm4, %xmm4
	...
	vaesenc	%xmm13, %xmm8, %xmm8
	#NO_APP
	vmovaps	112(%rbx), %xmm13
	vmovaps	%xmm13, 400(%rsp)
	#APP
	vaesenc	%xmm13, %xmm2, %xmm2
	vaesenc	%xmm13, %xmm3, %xmm3
	vaesenc	%xmm13, %xmm4, %xmm4
	...
	vaesenc	%xmm13, %xmm8, %xmm8
	#NO_APP
	vmovaps	128(%rbx), %xmm13
	vmovaps	%xmm13, 384(%rsp)
	#APP
	vaesenc	%xmm13, %xmm2, %xmm2
	vaesenc	%xmm13, %xmm3, %xmm3
	vaesenc	%xmm13, %xmm4, %xmm4
	...
	vaesenc	%xmm13, %xmm8, %xmm8
	#NO_APP
	vmovaps	144(%rbx), %xmm13
	vmovaps	%xmm13, 368(%rsp)
	#APP
	vaesenc	%xmm13, %xmm2, %xmm2
	vaesenc	%xmm13, %xmm3, %xmm3
	vaesenc	%xmm13, %xmm4, %xmm4
	...
	#NO_APP
	vpxor	(%r15), %xmm2, %xmm0
	vpxor	16(%r15), %xmm3, %xmm7
	vmovdqa	%xmm0, %xmm3
	vpxor	32(%r15), %xmm4, %xmm12
	vpxor	48(%r15), %xmm5, %xmm4
	vpxor	64(%r15), %xmm6, %xmm10
	vpxor	80(%r15), %xmm8, %xmm5
	vmovaps	256(%rbx), %xmm0
	vmovaps	%xmm0, 160(%rsp)
	vmovaps	272(%rbx), %xmm0
	vmovaps	%xmm0, 176(%rsp)
	vmovdqa	288(%rbx), %xmm8
...
.LBB1_31:
	...
	vpshufb	%xmm9, %xmm11, %xmm2
	vpaddd	.LCPI1_2(%rip), %xmm11, %xmm6
	vpshufb	%xmm9, %xmm6, %xmm6
	vpaddd	.LCPI1_4(%rip), %xmm11, %xmm8
	vpshufb	%xmm9, %xmm8, %xmm11
	vmovdqa	16(%rsp), %xmm0
	vpaddd	.LCPI1_5(%rip), %xmm0, %xmm8
	vpshufb	%xmm9, %xmm8, %xmm12
	vmovdqa	16(%rsp), %xmm0
	vpaddd	.LCPI1_6(%rip), %xmm0, %xmm8
	vpshufb	%xmm9, %xmm8, %xmm14
	vmovdqa	16(%rsp), %xmm0
	...
	vpxor	%xmm1, %xmm5, %xmm5
	vpclmulqdq	$0, %xmm13, %xmm0, %xmm1
	vpxor	%xmm1, %xmm15, %xmm15
	vpclmulqdq	$17, %xmm13, %xmm0, %xmm1
	vpxor	%xmm1, %xmm11, %xmm11
	vpclmulqdq	$1, %xmm13, %xmm0, %xmm1
	vpxor	%xmm1, %xmm5, %xmm5
	#NO_APP
	vmovdqa	%xmm3, %xmm13
	...
	vpaddd	.LCPI1_8(%rip), %xmm11, %xmm11
	...
	#NO_APP
	vpxor	(%r15), %xmm8, %xmm3
	vpxor	16(%r15), %xmm10, %xmm7
	vpxor	32(%r15), %xmm6, %xmm6
	vpxor	48(%r15), %xmm12, %xmm4
	vpxor	64(%r15), %xmm14, %xmm12
...
.LBB1_32:
	...
	vpshufb	%xmm9, %xmm7, %xmm2
	vpshufb	%xmm9, %xmm6, %xmm0
	vpshufb	%xmm9, %xmm4, %xmm3
	vpshufb	%xmm9, %xmm12, %xmm4
	vpshufb	%xmm9, %xmm5, %xmm5
	vmovdqa	48(%rsp), %xmm14
	...
	vpclmulqdq	$0, %xmm0, %xmm10, %xmm9
	vpxor	%xmm5, %xmm9, %xmm5
	vpxor	%xmm5, %xmm6, %xmm5
	vpclmulqdq	$1, %xmm0, %xmm10, %xmm6
	vpxor	%xmm6, %xmm8, %xmm6
...
.LBB2_35:
	...
	vxorps	48(%rsp), %xmm0, %xmm0
	vpxor	80(%rsp), %xmm1, %xmm1
	vpxor	144(%rsp), %xmm2, %xmm2
	vmovdqu	%xmm3, (%rax)
	vmovdqu	%xmm5, 16(%rax)
	vmovups	%xmm0, 32(%rax)
	vmovdqu	%xmm1, 48(%rax)
	vmovdqu	%xmm2, 64(%rax)
	vpxor	160(%rsp), %xmm13, %xmm0
	vmovdqu	%xmm0, 80(%rax)
	vmovdqa	%xmm8, %xmm0
	addq	$96, %r15
	addq	$96, %rax
