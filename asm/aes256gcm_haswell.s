...
.LBB1_10:
	...
	vpxor	%xmm7, %xmm8, %xmm7
	vpclmulqdq	$1, %xmm9, %xmm6, %xmm8
	vpxor	%xmm7, %xmm15, %xmm7
	vpclmulqdq	$16, %xmm9, %xmm6, %xmm14
...
.LBB1_28:
	...
	vaesenc	%xmm0, %xmm8, %xmm8
	#NO_APP
	vmovaps	80(%rbx), %xmm11
	vmovaps	%xmm11, 432(%rsp)
	#APP
	...
	#NO_APP
	vpxor	(%r15), %xmm2, %xmm0
	vpxor	16(%r15), %xmm3, %xmm15
	vmovdqa	%xmm0, %xmm3
	vpxor	32(%r15), %xmm4, %xmm9
	vpxor	48(%r15), %xmm5, %xmm7
	vpxor	64(%r15), %xmm6, %xmm4
	vpxor	80(%r15), %xmm8, %xmm5
	vmovaps	256(%rbx), %xmm0
	vmovaps	%xmm0, 160(%rsp)
	vmovaps	272(%rbx), %xmm0
	vmovdqa	288(%rbx), %xmm10
	vmovdqa	304(%rbx), %xmm6
	vmovdqa	320(%rbx), %xmm2
	vmovdqu	%xmm3, (%rax)
	vmovdqa	%xmm15, %xmm8
	vmovdqu	%xmm15, 16(%rax)
	vmovdqa	%xmm9, %xmm15
	vmovdqu	%xmm9, 32(%rax)
	vmovdqu	%xmm7, 48(%rax)
	vmovdqu	%xmm4, 64(%rax)
...
.LBB1_30:
	...
	vpshufb	%xmm14, %xmm13, %xmm2
	vpaddd	.LCPI1_2(%rip), %xmm13, %xmm6
	vpshufb	%xmm14, %xmm6, %xmm6
	vpaddd	.LCPI1_4(%rip), %xmm13, %xmm8
	vpshufb	%xmm14, %xmm8, %xmm12
	vpaddd	.LCPI1_5(%rip), %xmm13, %xmm8
	vpshufb	%xmm14, %xmm8, %xmm13
	vmovdqa	16(%rsp), %xmm0
	vpaddd	.LCPI1_6(%rip), %xmm0, %xmm8
	vmovdqa	%xmm14, %xmm9
	vpshufb	%xmm14, %xmm8, %xmm14
	vmovdqa	16(%rsp), %xmm0
	vpaddd	.LCPI1_7(%rip), %xmm0, %xmm8
	vpshufb	%xmm9, %xmm8, %xmm15
	vpxor	%xmm2, %xmm1, %xmm8
	vpxor	%xmm6, %xmm1, %xmm10
	vpxor	%xmm1, %xmm12, %xmm6
	vpxor	%xmm1, %xmm13, %xmm12
	vpxor	%xmm1, %xmm14, %xmm14
	vpxor	%xmm1, %xmm15, %xmm2
	...
	vpclmulqdq	$0, %xmm11, %xmm0, %xmm1
	vpxor	%xmm1, %xmm15, %xmm15
	vpclmulqdq	$17, %xmm11, %xmm0, %xmm1
	vpxor	%xmm1, %xmm5, %xmm5
	vpclmulqdq	$1, %xmm11, %xmm0, %xmm1
	vpxor	%xmm1, %xmm13, %xmm13
	#NO_APP
	vmovaps	%xmm3, %xmm11
	...
	#NO_APP
	vpxor	(%r15), %xmm8, %xmm3
	vpxor	16(%r15), %xmm10, %xmm8
	vpxor	32(%r15), %xmm6, %xmm15
	vpxor	48(%r15), %xmm12, %xmm7
	vpxor	64(%r15), %xmm14, %xmm4
	vmovdqa	%xmm9, %xmm14
	vpxor	80(%r15), %xmm2, %xmm5
	vmovdqu	%xmm3, (%rax)
	vmovdqu	%xmm8, 16(%rax)
	vmovdqu	%xmm15, 32(%rax)
	vmovdqu	%xmm7, 48(%rax)
	vmovdqu	%xmm4, 64(%rax)
	vmovdqu	%xmm5, 80(%rax)
	addq	$96, %r15
...
.LBB1_31:
	...
	vpclmulqdq	$1, %xmm0, %xmm12, %xmm10
	vpshufb	%xmm14, %xmm7, %xmm3
	vpclmulqdq	$16, %xmm0, %xmm12, %xmm11
	...
	vpclmulqdq	$16, %xmm3, %xmm11, %xmm10
...
.LBB2_18:
	...
	vpxor	%xmm14, %xmm12, %xmm12
	vpclmulqdq	$0, %xmm8, %xmm5, %xmm14
	vpxor	%xmm7, %xmm12, %xmm7
	vpclmulqdq	$1, %xmm8, %xmm5, %xmm12
	vpxor	%xmm9, %xmm11, %xmm9
	vpclmulqdq	$16, %xmm8, %xmm5, %xmm11
	vpxor	(%rsp), %xmm9, %xmm9
	vmovdqa	%xmm9, (%rsp)
...
.LBB2_19:
	...
	vpxor	%xmm9, %xmm8, %xmm8
	vpshufb	%xmm1, %xmm15, %xmm9
	vpclmulqdq	$0, %xmm9, %xmm0, %xmm11
	vpxor	%xmm7, %xmm8, %xmm7
	vpclmulqdq	$1, %xmm9, %xmm0, %xmm15
	...
	vpxor	%xmm7, %xmm15, %xmm7
	vpclmulqdq	$1, %xmm12, %xmm2, %xmm15
	vpxor	%xmm11, %xmm14, %xmm11
	vpclmulqdq	$16, %xmm12, %xmm2, %xmm14
	vmovdqa	(%rsp), %xmm13
...
.LBB2_35:
	...
	vpclmulqdq	$16, %xmm10, %xmm5, %xmm9
	vpxor	%xmm6, %xmm9, %xmm6
	vpclmulqdq	$0, %xmm10, %xmm5, %xmm9
	vpxor	%xmm3, %xmm9, %xmm3
	vpclmulqdq	$17, %xmm10, %xmm5, %xmm9
	vpxor	%xmm7, %xmm9, %xmm7
	...
	#NO_APP
	vmovdqu	(%r15), %xmm5
	vpshufb	%xmm4, %xmm5, %xmm9
	vpxor	32(%rsp), %xmm9, %xmm9
	...
	vpclmulqdq	$16, %xmm12, %xmm9, %xmm10
	vpxor	%xmm6, %xmm10, %xmm6
	vpclmulqdq	$0, %xmm12, %xmm9, %xmm10
	vpxor	%xmm3, %xmm10, %xmm3
	vpclmulqdq	$17, %xmm12, %xmm9, %xmm10
	vpxor	%xmm7, %xmm10, %xmm7
	vpclmulqdq	$1, %xmm12, %xmm9, %xmm10
	vpxor	%xmm6, %xmm10, %xmm6
	#NO_APP
	vpxor	%xmm10, %xmm10, %xmm10
	vpunpcklqdq	%xmm6, %xmm10, %xmm9
	vpxor	%xmm3, %xmm9, %xmm3
	vpunpckhqdq	%xmm10, %xmm6, %xmm6
	vpxor	%xmm6, %xmm7, %xmm6
	...
	#NO_APP
	vpxor	%xmm5, %xmm14, %xmm3
	vpxor	(%rsp), %xmm15, %xmm5
