...
.LBB1_24:
	...
	vmovdqa	(%rbx), %xmm1
	vmovaps	16(%rbx), %xmm0
	vmovaps	32(%rbx), %xmm14
	vmovaps	48(%rbx), %xmm15
	vpxor	%xmm2, %xmm1, %xmm2
	vpxor	%xmm3, %xmm1, %xmm3
	vpxor	%xmm4, %xmm1, %xmm4
	vpxor	%xmm5, %xmm1, %xmm5
	vpxor	%xmm6, %xmm1, %xmm8
	vpxor	%xmm7, %xmm1, %xmm10
	vmovaps	%xmm15, %xmm9
	...
	#NO_APP
	vpxor	(%r15), %xmm2, %xmm6
	vpxor	16(%r15), %xmm3, %xmm2
	vpxor	32(%r15), %xmm4, %xmm0
	vxorps	48(%r15), %xmm5, %xmm7
	vmovdqa	%xmm2, %xmm5
	vpxor	64(%r15), %xmm8, %xmm8
	vpxor	80(%r15), %xmm10, %xmm15
	leaq	96(%rdx), %rcx
	vmovdqa	224(%rbx), %xmm4
	vmovdqa	240(%rbx), %xmm3
	vmovdqa	256(%rbx), %xmm2
	vmovdqa	272(%rbx), %xmm10
	vmovdqa	288(%rbx), %xmm14
	vmovdqu	%xmm6, (%rdx)
	vmovdqu	%xmm5, 16(%rdx)
	vmovdqa	%xmm0, 64(%rsp)
	vmovdqu	%xmm0, 32(%rdx)
...
.LBB1_27:
	...
	vpshufb	%xmm12, %xmm11, %xmm2
	vpaddd	.LCPI1_2(%rip), %xmm11, %xmm3
	vpshufb	%xmm12, %xmm3, %xmm3
	vpaddd	.LCPI1_4(%rip), %xmm11, %xmm4
	vpshufb	%xmm12, %xmm4, %xmm8
	vpaddd	.LCPI1_5(%rip), %xmm11, %xmm4
	vpshufb	%xmm12, %xmm4, %xmm10
	vpaddd	.LCPI1_6(%rip), %xmm11, %xmm4
	vpshufb	%xmm12, %xmm4, %xmm11
	vmovdqa	.LCPI1_7(%rip), %xmm1
	vpaddd	32(%rsp), %xmm1, %xmm4
	vmovdqa	%xmm12, %xmm1
	vpshufb	%xmm12, %xmm4, %xmm12
	...
	vpxor	32(%rax), %xmm2, %xmm1
	vpxor	48(%rax), %xmm8, %xmm2
	vpxor	64(%rax), %xmm3, %xmm8
...
.LBB1_31:
	...
	vmovdqa	80(%rsp), %xmm7
.LBB1_32:
	vpshufb	%xmm12, %xmm6, %xmm1
	vpxor	%xmm1, %xmm0, %xmm1
	vpshufb	%xmm12, %xmm5, %xmm2
	vpshufb	%xmm12, %xmm8, %xmm3
	vpshufb	%xmm12, %xmm7, %xmm4
...
.LBB1_33:
	...
	vmovdqa	176(%rbx), %xmm4
	vmovdqa	192(%rbx), %xmm12
	vmovdqa	.LCPI1_1(%rip), %xmm3
	vpbroadcastq	.LCPI1_13(%rip), %xmm15
	.p2align	4, 0x90
.LBB1_34:
	vpshufb	%xmm3, %xmm11, %xmm14
	vpxor	32(%rsp), %xmm14, %xmm14
	...
	vmovdqu	%xmm14, (%rdx)
	vpxor	%xmm0, %xmm2, %xmm0
	vpclmulqdq	$1, %xmm0, %xmm13, %xmm14
	vpclmulqdq	$16, %xmm0, %xmm13, %xmm1
...
.LBB2_35:
	...
	#NO_APP
	vpxor	112(%rsp), %xmm12, %xmm1
	vpxor	%xmm5, %xmm13, %xmm3
	vpxor	32(%rsp), %xmm14, %xmm4
	vpxor	(%rsp), %xmm15, %xmm5
	vxorps	80(%rsp), %xmm0, %xmm0
	vmovdqu	%xmm1, (%rax)
	vmovdqu	%xmm3, 16(%rax)
	vmovdqa	%xmm7, %xmm3
	vmovdqu	%xmm4, 32(%rax)
