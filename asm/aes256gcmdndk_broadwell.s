...
.LBB1_36:
	...
	#NO_APP
	vpxor	(%rax), %xmm12, %xmm3
	vpxor	16(%rax), %xmm13, %xmm10
	vpxor	32(%rax), %xmm14, %xmm11
	vpxor	48(%rax), %xmm15, %xmm5
	vpxor	64(%rax), %xmm1, %xmm6
	vpxor	80(%rax), %xmm2, %xmm1
	addq	$96, %rax
	vmovdqu	%xmm3, (%rcx)
